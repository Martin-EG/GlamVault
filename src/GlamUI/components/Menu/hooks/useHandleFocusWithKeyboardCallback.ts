...
type UseHandleFocusWithKeyboardCallback = (props: UseHandleFocusWithKeyboardCallbackProps) => (e: React.KeyboardEvent) => void;
export const useHandleFocusWithKeyboardCallback: UseHandleFocusWithKeyboardCallback = ({ itemRefs }) => {
