...
describe('TextInput', () => {
  it('renders input correctly', () => {
    ...
    expect(input).toHaveAttribute('type', 'text'); // default variant
  });
  ...
  it('handles disabled state', () => {
    ...
    // Check if wrapper (parent) has disabled opacity style if possible,
    // or checks input disabled style via styled-components rule
